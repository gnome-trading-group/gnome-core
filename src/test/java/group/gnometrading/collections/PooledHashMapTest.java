...
class PooledHashMapTest {
    ...
    @Test
    void testResizing() {
        var map = new PooledHashMap<Integer, Integer>(1);
    ...
    private static GnomeMap<Integer, Integer> generate(String pairs) {
        GnomeMap<Integer, Integer> map = new PooledHashMap<>();
