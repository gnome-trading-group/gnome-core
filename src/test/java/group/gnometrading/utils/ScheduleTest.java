...
class ScheduleTest {
    ...
    void testConstructorWithZeroRepeatMillisThrowsException() {
        IllegalArgumentException exception =
                assertThrows(IllegalArgumentException.class, () -> new Schedule(mockClock, 0, mockTask));
    ...
    void testConstructorWithNegativeRepeatMillisThrowsException() {
        IllegalArgumentException exception =
                assertThrows(IllegalArgumentException.class, () -> new Schedule(mockClock, -1, mockTask));
        assertEquals("repeatMillis must be > 0", exception.getMessage());
    }
    ...
    void testConstructorWithLargeNegativeRepeatMillisThrowsException() {
        IllegalArgumentException exception =
                assertThrows(IllegalArgumentException.class, () -> new Schedule(mockClock, -1000000, mockTask));
        assertEquals("repeatMillis must be > 0", exception.getMessage());
    }
