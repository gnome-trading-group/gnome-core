...
public final class LongHashMap<T> implements LongMap<T> {
    ...
    private static int hash(final long key) {
        return (int) (key ^ (key >>> LONG_KEY_SHIFT));
    }
